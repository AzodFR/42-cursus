...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/22 17:12:02 by azod              #+#    #+#             */
/*   Updated: 2021/01/05 15:24:34 by azod             ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void draw_sprite(t_all *all, t_display *d, int type, int *array)
{
	...
	d->sprite_tex_x = (int)(256 * (d->stripe - (-d->spritewidth / 2 + d->spritescreen_x)) * all->text[3 + type].info[1] / d->spritewidth) / 256;
	y = d->drawstart_y;
