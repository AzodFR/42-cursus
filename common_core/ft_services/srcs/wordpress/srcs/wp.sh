#!/bin/sh
wp core install --url=https://192.168.99.123:5050 --title=BABINKS --admin_user=azod     --admin_password=admin --admin_email=rdm@email.com --path='/usr/share/webapps/wordpress/' --skip-email
while [ $? -ne 0 ] ; do
    wp core install --url=https://192.168.99.123:5050 --title=BABINKS --admin_user=azod     --admin_password=admin --admin_email=rdm@email.com --path='/usr/share/webapps/wordpress/' --skip-email
done
wp core install --url=https://192.168.99.123:5050 --title=BABINKS --admin_user=azod     --admin_password=admin --admin_email=rdm@email.com --path='/usr/share/webapps/wordpress/' --skip-email
